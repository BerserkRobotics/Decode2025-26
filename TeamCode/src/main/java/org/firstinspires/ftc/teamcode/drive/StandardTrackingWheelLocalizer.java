...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    //TODO: 2) configure them, 3) set distances here
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                ...
                new Pose2d(FORWARD_OFFSET, 0, Math.toRadians(90)) // back
        ));
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches((int) leftEncoder.getRawVelocity()) * X_MULTIPLIER,
                encoderTicksToInches((int) rightEncoder.getRawVelocity()) * X_MULTIPLIER,
                encoderTicksToInches((int) frontEncoder.getRawVelocity()) * Y_MULTIPLIER
        );
    }
}
